      ...
      <div class="card card-signin my-5">
        <div class="card-body">
          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
              <button class="btn btn-block btn-primary" :disabled="loggingIn">دخول</button>
...
export default {
  ...
  methods: {
    ...mapActions("account", ["loginPhone", "logoutt", "loginFacebook"]),
    ...
    handleSubmit(e) {
      ...
      if (UserName && Password) {
        this.loginPhone({ UserName, Password });
