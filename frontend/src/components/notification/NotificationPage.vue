<template>
  <div>
        ...
        <h5><i class=" fa fa-paper-plane-o"/> إرسال اشعارات </h5>
        <hr>
...
<div class="col-md-5">
   ...
   <div class="col-sm-8">
    ...
    <table style="width:650px !important;"  class="table"  v-if="boxes">
      <thead class="thead-light">
        <tr>
            <!--<th scope="col">#</th>-->
          <th style="    vertical-align: text-top;" scope="col">الأسم</th>
          <th style="    vertical-align: text-top;" scope="col">رقم الهاتف
             
          </th>
          <th scope="col"><span style="" >رقم الصندوق</span><br>
...
<td>
                    ...
                    <button @click="handleSubmit" class="btn btn-primary"><i class="fa fa-paper-plane-o"></i>إرسال</button>
                <a href="/admin/notification" style="margin:0 15px;" class="btn btn-danger">إلغاء</a>
       </form>
...
this.getAllType();
  ...
  countriesResults() {
     ...
     return this.boxes.filter((boxes) => {
       return boxes.numberBox.toString().indexOf(this.search) > -1;
     });
  }
},
  methods: {
